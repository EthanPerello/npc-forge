...
interface CharacterTraitsSectionProps {
  character: Character;
  onNestedChange: (section: 'selected_traits' | 'added_traits', field: string, value: string) => void;
}
  ...
  const handleTogglePersonalityTrait = (trait: string) => (e: React.MouseEvent) => {
    ...
    if (currentTraits.includes(trait)) {
      ...
      onNestedChange(
        'selected_traits', 
        'personality_traits', 
        currentTraits.filter(t => t !== trait) as any
      );
    } else {
    ...
    <FormSection title="Character Traits">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Select
          ...
          onChange={(e) => onNestedChange('selected_traits', 'gender', e.target.value as any)}
        />
        ...
        <Select
          ...
          onChange={(e) => onNestedChange('selected_traits', 'age_group', e.target.value as any)}
        />
        ...
        <Select
          ...
          onChange={(e) => onNestedChange('selected_traits', 'moral_alignment', e.target.value as any)}
        />
        ...
        <Select
          ...
          onChange={(e) => onNestedChange('selected_traits', 'relationship_to_player', e.target.value as any)}
        />
