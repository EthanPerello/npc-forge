...
export default function DeploymentPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Deployment Guide</h1>
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">Deployment Options</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 flex items-start">
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">Deployment to Vercel</h2>
        
        <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 mb-6">
          <h3 className="text-lg font-medium mb-3 text-indigo-700 dark:text-indigo-400">Prerequisites</h3>
        ...
        <h3 className="text-lg font-medium mb-3 text-indigo-700 dark:text-indigo-400">Deployment Steps</h3>
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">Deployment to Netlify</h2>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
              ...
              <li>Configure the build settings:
                <ul className="list-disc list-inside ml-4 space-y-1 text-gray-600 dark:text-gray-400">
                  <li>Build command: <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">npm run build</code></li>
                  <li>Publish directory: <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">.next</code></li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              In your repository, create a <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">netlify.toml</code> file with the following content:
            </p>
            <div className="bg-gray-800 text-gray-200 p-3 rounded-lg text-sm font-mono dark:bg-gray-900">
{`[build]
...
[[plugins]]
  package = "@netlify/plugin-nextjs"`}
          ...
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Commit and push the <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">netlify.toml</code> file to trigger a deployment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">Self-Hosting</h2>
...
{`npm install`}
          ...
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700">
            <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">3. Set up environment variables</h4>
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              Create a <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">.env.local</code> file with your OpenAI API key:
            </p>
            <div className="bg-gray-800 text-gray-200 p-3 rounded-lg text-sm font-mono dark:bg-gray-900">
{`OPENAI_API_KEY=your_api_key_here`}
            </div>
...
{`npm start`}
            ...
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              The application will be available at <code className="bg-gray-100 p-1 rounded dark:bg-gray-800">http://localhost:3000</code>.
            </p>
          </div>
...
{`server {
    ...
    location / {
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-700 dark:text-indigo-400">Deployment Checklist</h2>
